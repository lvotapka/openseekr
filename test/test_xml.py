...
def make_seekr_calculation():
    ...
    for i in range(3):
        ...
        milestone.anchor = 'test_anchor_%d' % i
...
def verify_seekr_identical(seekr1, seekr2):
    ...
    for i in range(len(seekr1.milestones)):
        ...
        assertEq(seekr1.milestones[i].anchor, seekr2.milestones[i].anchor)
        assertEq(seekr1.milestones[i].center_atom_indices, 
                 seekr2.milestones[i].center_atom_indices)
        assertEq(seekr1.milestones[i].center_vec, seekr2.milestones[i].center_vec)
        ...
        assertEqQuantities(seekr1.milestones[i].box_vectors[0][0], 
                           seekr2.milestones[i].box_vectors[0][0])
