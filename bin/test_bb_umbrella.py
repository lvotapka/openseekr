...
#picklename = '/home/lvotapka/hsp90_gdm_add_more/seekr_calc.pickle'
#picklename = '/home/lvotapka/hsp90_gdm/seekr_calc.pickle'
...
lig_selection = [2266, 2388]
rec_selection = [833, 549]
...
for milestone in all_milestones:
  if milestone.md:
    ...
    if rec_selection:
      milestone.atom_indices1 = rec_selection
    if lig_selection:
      milestone.atom_indices2 = lig_selection
