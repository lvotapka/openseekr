...
class _Selections():
    ...
    def serialize(self, xmlSelections):
        ...
        xmlLig_com_indices.text = ','.join(list(map(str, self.lig_com_indices)))
        '''
        ...
        xmlSite_com_indices.text = ','.join(list(map(str, self.site_com_indices)))
        '''
...
class _Min_Equil():
    ...
    def serialize(self, xmlMin_equil):
        ...
        xmlTemp_equil_temperatures.text = ','.join(list(map(str, self.temp_equil_temperatures)))
        '''
