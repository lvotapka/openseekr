...
rec_site_atom_indices = [2478, 2489, 2499, 2535, 2718, 2745, 2769, 2787, 2794, 
                         2867, 2926] # Selected by "index" in VMD
...
me.min_equil.temp_equil_steps = 1000 # number of steps per temperature
...
me.browndye.apbs.inputgen.executable = \
    '/home/lvotapka/Downloads/APBS-1.5-linux64/share/apbs/tools/manip/' \
    'inputgen.py'
...
milestones = seekr.generate_spherical_milestones(me, rec_site_atom_indices, 
                                                 origin, radius_list, 0, 
                                                 vectors, absolute=False)
...
ligand_heavy_indices = seekr.find_heavy_atoms(holo_config_wet, list(range(
    insert_index, insert_index+last_ligand_index+1)))
...
for milestone in me.milestones:
    ...
    if milestone.md:
        ...
        parm.box = np.array([64.9127105, 64.9127105, 
                             64.9127105,109.471219, 
        ...
        if not me.openmm.simulation: # create a sample simulation file
