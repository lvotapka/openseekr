...
protein_backward_dict = {"I": "ILE", "Q": "GLN", "T": "THR", "G": "GLY", "H": "HIS", "W": "TRP", "E": "GLU", "C": "CYS", "D": "ASP", "S": "SER", "P": "PRO", "K": "LYS", "F": "PHE", "A": "ALA", "M": "MET", "L": "LEU", "R": "ARG", "V": "VAL", "N": "ASN", "Y": "TYR"}
...
class Big_PDBParser():
    def pdbparse(self, filename, preserve_index = False, preserve_resid = True, pqr=False, conventional=False, multi_frame=False):
    ...
    def get_structure(self, struct_id, filename, preserve_index=False, preserve_resid=True, pqr=False, pqrxml=False, conventional=False, multi_frame=False):
